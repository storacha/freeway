/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a047019d855396b88a971e4e8c90ee0e)
// Runtime types generated with workerd@1.20251011.0 2025-09-01 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		CONTENT_CLAIMS_SERVICE_URL: "https://dev.claims.web3.storage" | "https://claims.web3.storage" | "https://staging.claims.web3.storage" | "https://test.claims.web3.storage";
		GATEWAY_SERVICE_DID: "did:web:staging.w3s.link" | "did:web:w3s.link";
		UPLOAD_SERVICE_DID: "did:web:staging.web3.storage" | "did:web:web3.storage" | "did:web:staging.up.storacha.network";
		UPLOAD_API_URL: "https://staging.up.web3.storage" | "https://up.web3.storage";
		MAX_SHARDS: "825" | "120";
		FF_RATE_LIMITER_ENABLED: "false" | "true";
		FF_EGRESS_TRACKER_ENABLED: "true" | "false";
		FF_TELEMETRY_ENABLED: "true" | "false";
		FF_DELEGATIONS_STORAGE_ENABLED: "true";
		FF_RAMP_UP_PROBABILITY: "100";
		FF_DAGPB_CONTENT_CACHE_TTL_SECONDS: 2592000 | 300;
		FF_DAGPB_CONTENT_CACHE_MAX_SIZE_MB: 2;
		FF_DAGPB_CONTENT_CACHE_ENABLED: "true";
		TELEMETRY_RATIO: 0.0005 | 1;
		CARPARK_PUBLIC_BUCKET_URL: "https://carpark-prod-0.r2.w3s.link" | "https://carpark-staging-0.r2.w3s.link";
		INDEXING_SERVICE_URL: "https://indexer.storacha.network/" | "https://staging.indexer.storacha.network/";
		DEBUG: "true";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CONTENT_CLAIMS_SERVICE_URL" | "GATEWAY_SERVICE_DID" | "UPLOAD_SERVICE_DID" | "UPLOAD_API_URL" | "MAX_SHARDS" | "FF_RATE_LIMITER_ENABLED" | "FF_EGRESS_TRACKER_ENABLED" | "FF_TELEMETRY_ENABLED" | "FF_DELEGATIONS_STORAGE_ENABLED" | "FF_RAMP_UP_PROBABILITY" | "FF_DAGPB_CONTENT_CACHE_TTL_SECONDS" | "FF_DAGPB_CONTENT_CACHE_MAX_SIZE_MB" | "FF_DAGPB_CONTENT_CACHE_ENABLED" | "TELEMETRY_RATIO" | "CARPARK_PUBLIC_BUCKET_URL" | "INDEXING_SERVICE_URL" | "DEBUG" | "HONEYCOMB_API_KEY">> {}
}
